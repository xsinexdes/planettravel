...
public class PlanetTravel extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        // --- 3) Mundos ---
        this.temperatureManager = new TemperatureManager(suitManager, configManager);
        ...
        new SelectionPreviewTask(this, selectionManager, configManager).runTaskTimer(this, 20L, 10L);
        ...
        getServer().getPluginManager().registerEvents(new SpaceProtectionListener(this, configManager, resolver), this);
        getServer().getPluginManager().registerEvents(new WandListener(selectionManager, configManager), this);
