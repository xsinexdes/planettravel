...
public class PlanetEditorGUI {
    ...
    public void abrir(Player jugador, PlanetData planeta) {
        ...
        inv.setItem(SLOT_SALIDA, valor(Material.ORANGE_DYE, "§6Margen de salida (despegue)",
                (int) planeta.getSalidaMargen() + " §7bloques"));

        inv.setItem(SLOT_ZONA_INFO, item(Material.MAP, "§dComo funciona el viaje",
                "§7Entrada: se elige un punto al azar",
                "§7dentro de la zona marcada arriba.",
                "",
                "§7Salida: es AUTOMATICA. Al despegar",
                "§7apareces justo fuera del radio de",
                "§7deteccion (+ el margen de al lado),",
                "§7en una direccion al azar. No hace",
                "§7falta marcar nada para despegar."));
